...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Eddystone",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (NSArray<NSNumber *> * _Nonnull)getBeaconID SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL_NAMED("EddystoneScannerDelegate")
@protocol EddystoneScannerDelegate
- (void)didFindBeaconWithBeaconScanner:(EddystoneScanner * _Nonnull)beaconScanner beaconInfo:(BeaconInfo * _Nonnull)beaconInfo;
- (void)didLoseBeaconWithBeaconScanner:(EddystoneScanner * _Nonnull)beaconScanner beaconInfo:(BeaconInfo * _Nonnull)beaconInfo;
- (void)didUpdateBeaconWithBeaconScanner:(EddystoneScanner * _Nonnull)beaconScanner beaconInfo:(BeaconInfo * _Nonnull)beaconInfo;
- (void)didObserveURLBeaconWithBeaconScanner:(EddystoneScanner * _Nonnull)beaconScanner URL:(NSURL * _Nonnull)URL RSSI:(NSInteger)RSSI;
@end
